...
@ControllerAdvice
public class ExceptionBookStoreHandler {
	...
	@ResponseStatus(value = HttpStatus.INTERNAL_SERVER_ERROR)
	public @ResponseBody ExceptionResponse handleBookServiceException(final BookServiceException exception, final HttpServletRequest request) {
		return new ExceptionResponse(new Date(), exception.getMessage(), request.getRequestURI());
	}
